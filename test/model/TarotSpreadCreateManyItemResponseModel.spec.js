...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadCreateManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadCreateManyItemResponseModel();
      });

      it('should create an instance of TarotSpreadCreateManyItemResponseModel', function() {
        // TODO: update the code to test TarotSpreadCreateManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotSpreadCreateManyItemResponseModel);
      });
