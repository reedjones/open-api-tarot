...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardPatchManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardPatchManyItemResponseModel();
      });

      it('should create an instance of TarotDeckCardPatchManyItemResponseModel', function() {
        // TODO: update the code to test TarotDeckCardPatchManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCardPatchManyItemResponseModel);
      });
