...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadPatchManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadPatchManyItemResponseModel();
      });

      it('should create an instance of TarotSpreadPatchManyItemResponseModel', function() {
        // TODO: update the code to test TarotSpreadPatchManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotSpreadPatchManyItemResponseModel);
      });
