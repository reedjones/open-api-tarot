...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserFindOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserFindOneResponseModel();
      });

      it('should create an instance of AuthUserFindOneResponseModel', function() {
        // TODO: update the code to test AuthUserFindOneResponseModel
        expect(instance).to.be.a(FastApi.AuthUserFindOneResponseModel);
      });
