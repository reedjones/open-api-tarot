...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadFindManyResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadFindManyResponseModel();
      });

      it('should create an instance of TarotSpreadFindManyResponseModel', function() {
        // TODO: update the code to test TarotSpreadFindManyResponseModel
        expect(instance).to.be.a(FastApi.TarotSpreadFindManyResponseModel);
      });
