...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateManyByQuerySpreadsPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateManyByQuerySpreadsPut();
      });

      it('should create an instance of BodyEntireUpdateManyByQuerySpreadsPut', function() {
        // TODO: update the code to test BodyEntireUpdateManyByQuerySpreadsPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateManyByQuerySpreadsPut);
      });
