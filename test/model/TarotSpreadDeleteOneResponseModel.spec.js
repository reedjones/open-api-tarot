...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadDeleteOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadDeleteOneResponseModel();
      });

      it('should create an instance of TarotSpreadDeleteOneResponseModel', function() {
        // TODO: update the code to test TarotSpreadDeleteOneResponseModel
        expect(instance).to.be.a(FastApi.TarotSpreadDeleteOneResponseModel);
      });
