...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyPartialUpdateOneByPrimaryKeyProductsIdPatch', function() {
      beforeEach(function() {
        instance = new FastApi.BodyPartialUpdateOneByPrimaryKeyProductsIdPatch();
      });

      it('should create an instance of BodyPartialUpdateOneByPrimaryKeyProductsIdPatch', function() {
        // TODO: update the code to test BodyPartialUpdateOneByPrimaryKeyProductsIdPatch
        expect(instance).to.be.a(FastApi.BodyPartialUpdateOneByPrimaryKeyProductsIdPatch);
      });
