...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotProductCreateManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotProductCreateManyItemResponseModel();
      });

      it('should create an instance of TarotProductCreateManyItemResponseModel', function() {
        // TODO: update the code to test TarotProductCreateManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotProductCreateManyItemResponseModel);
      });
