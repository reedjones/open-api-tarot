...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardUpdateOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardUpdateOneResponseModel();
      });

      it('should create an instance of TarotDeckCardUpdateOneResponseModel', function() {
        // TODO: update the code to test TarotDeckCardUpdateOneResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCardUpdateOneResponseModel);
      });
