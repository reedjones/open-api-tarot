...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardDeleteManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardDeleteManyItemResponseModel();
      });

      it('should create an instance of TarotDeckCardDeleteManyItemResponseModel', function() {
        // TODO: update the code to test TarotDeckCardDeleteManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCardDeleteManyItemResponseModel);
      });
