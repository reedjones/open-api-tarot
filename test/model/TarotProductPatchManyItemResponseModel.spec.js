...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotProductPatchManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotProductPatchManyItemResponseModel();
      });

      it('should create an instance of TarotProductPatchManyItemResponseModel', function() {
        // TODO: update the code to test TarotProductPatchManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotProductPatchManyItemResponseModel);
      });
