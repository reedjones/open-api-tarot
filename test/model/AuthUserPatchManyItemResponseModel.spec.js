...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserPatchManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserPatchManyItemResponseModel();
      });

      it('should create an instance of AuthUserPatchManyItemResponseModel', function() {
        // TODO: update the code to test AuthUserPatchManyItemResponseModel
        expect(instance).to.be.a(FastApi.AuthUserPatchManyItemResponseModel);
      });
