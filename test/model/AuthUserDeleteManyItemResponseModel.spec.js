...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserDeleteManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserDeleteManyItemResponseModel();
      });

      it('should create an instance of AuthUserDeleteManyItemResponseModel', function() {
        // TODO: update the code to test AuthUserDeleteManyItemResponseModel
        expect(instance).to.be.a(FastApi.AuthUserDeleteManyItemResponseModel);
      });
