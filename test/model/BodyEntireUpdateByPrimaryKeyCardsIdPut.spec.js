...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateByPrimaryKeyCardsIdPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateByPrimaryKeyCardsIdPut();
      });

      it('should create an instance of BodyEntireUpdateByPrimaryKeyCardsIdPut', function() {
        // TODO: update the code to test BodyEntireUpdateByPrimaryKeyCardsIdPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateByPrimaryKeyCardsIdPut);
      });
