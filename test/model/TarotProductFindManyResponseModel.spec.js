...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotProductFindManyResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotProductFindManyResponseModel();
      });

      it('should create an instance of TarotProductFindManyResponseModel', function() {
        // TODO: update the code to test TarotProductFindManyResponseModel
        expect(instance).to.be.a(FastApi.TarotProductFindManyResponseModel);
      });
