...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateManyByQueryUsersPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateManyByQueryUsersPut();
      });

      it('should create an instance of BodyEntireUpdateManyByQueryUsersPut', function() {
        // TODO: update the code to test BodyEntireUpdateManyByQueryUsersPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateManyByQueryUsersPut);
      });
