...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckUpdateOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckUpdateOneResponseModel();
      });

      it('should create an instance of TarotDeckUpdateOneResponseModel', function() {
        // TODO: update the code to test TarotDeckUpdateOneResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckUpdateOneResponseModel);
      });
