...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardFindManyResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardFindManyResponseModel();
      });

      it('should create an instance of TarotDeckCardFindManyResponseModel', function() {
        // TODO: update the code to test TarotDeckCardFindManyResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCardFindManyResponseModel);
      });
