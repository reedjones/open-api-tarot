...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateManyByQueryProductsPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateManyByQueryProductsPut();
      });

      it('should create an instance of BodyEntireUpdateManyByQueryProductsPut', function() {
        // TODO: update the code to test BodyEntireUpdateManyByQueryProductsPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateManyByQueryProductsPut);
      });
