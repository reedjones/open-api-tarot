...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyPartialUpdateManyByQuerySpreadsPatch', function() {
      beforeEach(function() {
        instance = new FastApi.BodyPartialUpdateManyByQuerySpreadsPatch();
      });

      it('should create an instance of BodyPartialUpdateManyByQuerySpreadsPatch', function() {
        // TODO: update the code to test BodyPartialUpdateManyByQuerySpreadsPatch
        expect(instance).to.be.a(FastApi.BodyPartialUpdateManyByQuerySpreadsPatch);
      });
