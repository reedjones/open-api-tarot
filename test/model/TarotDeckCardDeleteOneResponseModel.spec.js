...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardDeleteOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardDeleteOneResponseModel();
      });

      it('should create an instance of TarotDeckCardDeleteOneResponseModel', function() {
        // TODO: update the code to test TarotDeckCardDeleteOneResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCardDeleteOneResponseModel);
      });
