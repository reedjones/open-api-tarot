...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckDeleteOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckDeleteOneResponseModel();
      });

      it('should create an instance of TarotDeckDeleteOneResponseModel', function() {
        // TODO: update the code to test TarotDeckDeleteOneResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckDeleteOneResponseModel);
      });
