...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardPatchOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardPatchOneResponseModel();
      });

      it('should create an instance of TarotDeckCardPatchOneResponseModel', function() {
        // TODO: update the code to test TarotDeckCardPatchOneResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCardPatchOneResponseModel);
      });
