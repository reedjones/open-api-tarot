...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateByPrimaryKeyProductsIdPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateByPrimaryKeyProductsIdPut();
      });

      it('should create an instance of BodyEntireUpdateByPrimaryKeyProductsIdPut', function() {
        // TODO: update the code to test BodyEntireUpdateByPrimaryKeyProductsIdPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateByPrimaryKeyProductsIdPut);
      });
