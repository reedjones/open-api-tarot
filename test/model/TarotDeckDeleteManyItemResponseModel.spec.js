...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckDeleteManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckDeleteManyItemResponseModel();
      });

      it('should create an instance of TarotDeckDeleteManyItemResponseModel', function() {
        // TODO: update the code to test TarotDeckDeleteManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckDeleteManyItemResponseModel);
      });
