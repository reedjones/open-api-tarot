...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserUpdateManyResponseItemModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserUpdateManyResponseItemModel();
      });

      it('should create an instance of AuthUserUpdateManyResponseItemModel', function() {
        // TODO: update the code to test AuthUserUpdateManyResponseItemModel
        expect(instance).to.be.a(FastApi.AuthUserUpdateManyResponseItemModel);
      });
