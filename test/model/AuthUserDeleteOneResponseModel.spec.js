...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserDeleteOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserDeleteOneResponseModel();
      });

      it('should create an instance of AuthUserDeleteOneResponseModel', function() {
        // TODO: update the code to test AuthUserDeleteOneResponseModel
        expect(instance).to.be.a(FastApi.AuthUserDeleteOneResponseModel);
      });
