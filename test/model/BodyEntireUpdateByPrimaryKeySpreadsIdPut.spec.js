...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateByPrimaryKeySpreadsIdPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateByPrimaryKeySpreadsIdPut();
      });

      it('should create an instance of BodyEntireUpdateByPrimaryKeySpreadsIdPut', function() {
        // TODO: update the code to test BodyEntireUpdateByPrimaryKeySpreadsIdPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateByPrimaryKeySpreadsIdPut);
      });
