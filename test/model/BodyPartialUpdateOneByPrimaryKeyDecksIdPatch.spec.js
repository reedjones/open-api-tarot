...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyPartialUpdateOneByPrimaryKeyDecksIdPatch', function() {
      beforeEach(function() {
        instance = new FastApi.BodyPartialUpdateOneByPrimaryKeyDecksIdPatch();
      });

      it('should create an instance of BodyPartialUpdateOneByPrimaryKeyDecksIdPatch', function() {
        // TODO: update the code to test BodyPartialUpdateOneByPrimaryKeyDecksIdPatch
        expect(instance).to.be.a(FastApi.BodyPartialUpdateOneByPrimaryKeyDecksIdPatch);
      });
