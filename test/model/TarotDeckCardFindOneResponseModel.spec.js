...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardFindOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardFindOneResponseModel();
      });

      it('should create an instance of TarotDeckCardFindOneResponseModel', function() {
        // TODO: update the code to test TarotDeckCardFindOneResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCardFindOneResponseModel);
      });
