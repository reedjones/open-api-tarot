...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotProductUpdateManyResponseItemModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotProductUpdateManyResponseItemModel();
      });

      it('should create an instance of TarotProductUpdateManyResponseItemModel', function() {
        // TODO: update the code to test TarotProductUpdateManyResponseItemModel
        expect(instance).to.be.a(FastApi.TarotProductUpdateManyResponseItemModel);
      });
