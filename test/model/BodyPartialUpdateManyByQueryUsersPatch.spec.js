...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyPartialUpdateManyByQueryUsersPatch', function() {
      beforeEach(function() {
        instance = new FastApi.BodyPartialUpdateManyByQueryUsersPatch();
      });

      it('should create an instance of BodyPartialUpdateManyByQueryUsersPatch', function() {
        // TODO: update the code to test BodyPartialUpdateManyByQueryUsersPatch
        expect(instance).to.be.a(FastApi.BodyPartialUpdateManyByQueryUsersPatch);
      });
