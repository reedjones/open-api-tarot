...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadFindOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadFindOneResponseModel();
      });

      it('should create an instance of TarotSpreadFindOneResponseModel', function() {
        // TODO: update the code to test TarotSpreadFindOneResponseModel
        expect(instance).to.be.a(FastApi.TarotSpreadFindOneResponseModel);
      });
