...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotProductPatchOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotProductPatchOneResponseModel();
      });

      it('should create an instance of TarotProductPatchOneResponseModel', function() {
        // TODO: update the code to test TarotProductPatchOneResponseModel
        expect(instance).to.be.a(FastApi.TarotProductPatchOneResponseModel);
      });
