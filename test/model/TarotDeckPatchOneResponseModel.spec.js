...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckPatchOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckPatchOneResponseModel();
      });

      it('should create an instance of TarotDeckPatchOneResponseModel', function() {
        // TODO: update the code to test TarotDeckPatchOneResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckPatchOneResponseModel);
      });
