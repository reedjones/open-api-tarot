...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserCreateManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserCreateManyItemResponseModel();
      });

      it('should create an instance of AuthUserCreateManyItemResponseModel', function() {
        // TODO: update the code to test AuthUserCreateManyItemResponseModel
        expect(instance).to.be.a(FastApi.AuthUserCreateManyItemResponseModel);
      });
