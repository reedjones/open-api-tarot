...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCreateManyItemRequestModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCreateManyItemRequestModel();
      });

      it('should create an instance of TarotDeckCreateManyItemRequestModel', function() {
        // TODO: update the code to test TarotDeckCreateManyItemRequestModel
        expect(instance).to.be.a(FastApi.TarotDeckCreateManyItemRequestModel);
      });
