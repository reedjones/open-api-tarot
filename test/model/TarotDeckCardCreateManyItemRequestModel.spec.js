...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardCreateManyItemRequestModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardCreateManyItemRequestModel();
      });

      it('should create an instance of TarotDeckCardCreateManyItemRequestModel', function() {
        // TODO: update the code to test TarotDeckCardCreateManyItemRequestModel
        expect(instance).to.be.a(FastApi.TarotDeckCardCreateManyItemRequestModel);
      });
