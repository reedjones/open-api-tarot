...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserFindManyItemListResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserFindManyItemListResponseModel();
      });

      it('should create an instance of AuthUserFindManyItemListResponseModel', function() {
        // TODO: update the code to test AuthUserFindManyItemListResponseModel
        expect(instance).to.be.a(FastApi.AuthUserFindManyItemListResponseModel);
      });
