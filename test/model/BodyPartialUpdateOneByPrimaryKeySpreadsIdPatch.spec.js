...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyPartialUpdateOneByPrimaryKeySpreadsIdPatch', function() {
      beforeEach(function() {
        instance = new FastApi.BodyPartialUpdateOneByPrimaryKeySpreadsIdPatch();
      });

      it('should create an instance of BodyPartialUpdateOneByPrimaryKeySpreadsIdPatch', function() {
        // TODO: update the code to test BodyPartialUpdateOneByPrimaryKeySpreadsIdPatch
        expect(instance).to.be.a(FastApi.BodyPartialUpdateOneByPrimaryKeySpreadsIdPatch);
      });
