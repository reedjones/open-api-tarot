...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckFindOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckFindOneResponseModel();
      });

      it('should create an instance of TarotDeckFindOneResponseModel', function() {
        // TODO: update the code to test TarotDeckFindOneResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckFindOneResponseModel);
      });
