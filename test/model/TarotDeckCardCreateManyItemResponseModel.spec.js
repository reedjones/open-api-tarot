...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardCreateManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardCreateManyItemResponseModel();
      });

      it('should create an instance of TarotDeckCardCreateManyItemResponseModel', function() {
        // TODO: update the code to test TarotDeckCardCreateManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCardCreateManyItemResponseModel);
      });
