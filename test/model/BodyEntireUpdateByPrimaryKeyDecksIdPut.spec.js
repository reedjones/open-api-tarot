...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateByPrimaryKeyDecksIdPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateByPrimaryKeyDecksIdPut();
      });

      it('should create an instance of BodyEntireUpdateByPrimaryKeyDecksIdPut', function() {
        // TODO: update the code to test BodyEntireUpdateByPrimaryKeyDecksIdPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateByPrimaryKeyDecksIdPut);
      });
