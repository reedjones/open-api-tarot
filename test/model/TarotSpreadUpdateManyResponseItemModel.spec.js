...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadUpdateManyResponseItemModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadUpdateManyResponseItemModel();
      });

      it('should create an instance of TarotSpreadUpdateManyResponseItemModel', function() {
        // TODO: update the code to test TarotSpreadUpdateManyResponseItemModel
        expect(instance).to.be.a(FastApi.TarotSpreadUpdateManyResponseItemModel);
      });
