...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateByPrimaryKeyUsersIdPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateByPrimaryKeyUsersIdPut();
      });

      it('should create an instance of BodyEntireUpdateByPrimaryKeyUsersIdPut', function() {
        // TODO: update the code to test BodyEntireUpdateByPrimaryKeyUsersIdPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateByPrimaryKeyUsersIdPut);
      });
