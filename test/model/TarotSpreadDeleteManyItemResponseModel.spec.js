...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadDeleteManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadDeleteManyItemResponseModel();
      });

      it('should create an instance of TarotSpreadDeleteManyItemResponseModel', function() {
        // TODO: update the code to test TarotSpreadDeleteManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotSpreadDeleteManyItemResponseModel);
      });
