...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotProductCreateManyItemRequestModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotProductCreateManyItemRequestModel();
      });

      it('should create an instance of TarotProductCreateManyItemRequestModel', function() {
        // TODO: update the code to test TarotProductCreateManyItemRequestModel
        expect(instance).to.be.a(FastApi.TarotProductCreateManyItemRequestModel);
      });
