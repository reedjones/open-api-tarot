...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckUpdateManyResponseItemModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckUpdateManyResponseItemModel();
      });

      it('should create an instance of TarotDeckUpdateManyResponseItemModel', function() {
        // TODO: update the code to test TarotDeckUpdateManyResponseItemModel
        expect(instance).to.be.a(FastApi.TarotDeckUpdateManyResponseItemModel);
      });
