...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserPatchOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserPatchOneResponseModel();
      });

      it('should create an instance of AuthUserPatchOneResponseModel', function() {
        // TODO: update the code to test AuthUserPatchOneResponseModel
        expect(instance).to.be.a(FastApi.AuthUserPatchOneResponseModel);
      });
