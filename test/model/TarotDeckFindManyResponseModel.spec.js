...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckFindManyResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckFindManyResponseModel();
      });

      it('should create an instance of TarotDeckFindManyResponseModel', function() {
        // TODO: update the code to test TarotDeckFindManyResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckFindManyResponseModel);
      });
