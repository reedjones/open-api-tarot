...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCreateManyItemResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCreateManyItemResponseModel();
      });

      it('should create an instance of TarotDeckCreateManyItemResponseModel', function() {
        // TODO: update the code to test TarotDeckCreateManyItemResponseModel
        expect(instance).to.be.a(FastApi.TarotDeckCreateManyItemResponseModel);
      });
