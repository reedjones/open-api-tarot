...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserUpdateOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserUpdateOneResponseModel();
      });

      it('should create an instance of AuthUserUpdateOneResponseModel', function() {
        // TODO: update the code to test AuthUserUpdateOneResponseModel
        expect(instance).to.be.a(FastApi.AuthUserUpdateOneResponseModel);
      });
