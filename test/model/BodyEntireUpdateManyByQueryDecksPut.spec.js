...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyEntireUpdateManyByQueryDecksPut', function() {
      beforeEach(function() {
        instance = new FastApi.BodyEntireUpdateManyByQueryDecksPut();
      });

      it('should create an instance of BodyEntireUpdateManyByQueryDecksPut', function() {
        // TODO: update the code to test BodyEntireUpdateManyByQueryDecksPut
        expect(instance).to.be.a(FastApi.BodyEntireUpdateManyByQueryDecksPut);
      });
