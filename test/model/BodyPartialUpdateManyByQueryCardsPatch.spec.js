...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyPartialUpdateManyByQueryCardsPatch', function() {
      beforeEach(function() {
        instance = new FastApi.BodyPartialUpdateManyByQueryCardsPatch();
      });

      it('should create an instance of BodyPartialUpdateManyByQueryCardsPatch', function() {
        // TODO: update the code to test BodyPartialUpdateManyByQueryCardsPatch
        expect(instance).to.be.a(FastApi.BodyPartialUpdateManyByQueryCardsPatch);
      });
