...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyPartialUpdateOneByPrimaryKeyUsersIdPatch', function() {
      beforeEach(function() {
        instance = new FastApi.BodyPartialUpdateOneByPrimaryKeyUsersIdPatch();
      });

      it('should create an instance of BodyPartialUpdateOneByPrimaryKeyUsersIdPatch', function() {
        // TODO: update the code to test BodyPartialUpdateOneByPrimaryKeyUsersIdPatch
        expect(instance).to.be.a(FastApi.BodyPartialUpdateOneByPrimaryKeyUsersIdPatch);
      });
