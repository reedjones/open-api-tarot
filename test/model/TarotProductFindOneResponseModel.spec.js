...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotProductFindOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotProductFindOneResponseModel();
      });

      it('should create an instance of TarotProductFindOneResponseModel', function() {
        // TODO: update the code to test TarotProductFindOneResponseModel
        expect(instance).to.be.a(FastApi.TarotProductFindOneResponseModel);
      });
