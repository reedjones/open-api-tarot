...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotProductDeleteOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotProductDeleteOneResponseModel();
      });

      it('should create an instance of TarotProductDeleteOneResponseModel', function() {
        // TODO: update the code to test TarotProductDeleteOneResponseModel
        expect(instance).to.be.a(FastApi.TarotProductDeleteOneResponseModel);
      });
