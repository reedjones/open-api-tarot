...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthUserFindManyResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.AuthUserFindManyResponseModel();
      });

      it('should create an instance of AuthUserFindManyResponseModel', function() {
        // TODO: update the code to test AuthUserFindManyResponseModel
        expect(instance).to.be.a(FastApi.AuthUserFindManyResponseModel);
      });
