...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotDeckCardUpdateManyResponseItemModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotDeckCardUpdateManyResponseItemModel();
      });

      it('should create an instance of TarotDeckCardUpdateManyResponseItemModel', function() {
        // TODO: update the code to test TarotDeckCardUpdateManyResponseItemModel
        expect(instance).to.be.a(FastApi.TarotDeckCardUpdateManyResponseItemModel);
      });
