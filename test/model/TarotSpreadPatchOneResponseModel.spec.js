...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadPatchOneResponseModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadPatchOneResponseModel();
      });

      it('should create an instance of TarotSpreadPatchOneResponseModel', function() {
        // TODO: update the code to test TarotSpreadPatchOneResponseModel
        expect(instance).to.be.a(FastApi.TarotSpreadPatchOneResponseModel);
      });
