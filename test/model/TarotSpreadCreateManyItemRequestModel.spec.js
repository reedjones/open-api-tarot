...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TarotSpreadCreateManyItemRequestModel', function() {
      beforeEach(function() {
        instance = new FastApi.TarotSpreadCreateManyItemRequestModel();
      });

      it('should create an instance of TarotSpreadCreateManyItemRequestModel', function() {
        // TODO: update the code to test TarotSpreadCreateManyItemRequestModel
        expect(instance).to.be.a(FastApi.TarotSpreadCreateManyItemRequestModel);
      });
